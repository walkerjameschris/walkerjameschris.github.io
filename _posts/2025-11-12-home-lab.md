...
- [SearXNG](searxng.org/): A self-hosted search engine
...
SearXNG is a self-hosted search engine! It allows for total privacy and
control of searches. Even better, it allows me to connect Open WebUI
with Ollama models to SearXNG to perform RAG for web search! This means
my web searches are *completely* private and self hosted with Ollama,
SearXNG, and Open WebUI.
